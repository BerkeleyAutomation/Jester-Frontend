    ...
    function () {
        function e(e, t) {
            ...
            function h(e, n, r, a) {
                ...
                for (var i = m(n); ;) {
                    if (!o(i))return null;
                    var d = i + (e ? -1 : 1), c = null;
                    if (o(d) ? c = b[d] : t && (c = e ? p() : f(), d = m(c)), null === c || d === a)return null;
                    if (r(c))return c;
                    angular.isUndefined(a) && (a = d), i = d
                }
            }
 ...
 */
    function () {
        function e(e, t, n) {
            ...
            var m = {}, u = {}, f = {}, p = {};
            return r.getResponsiveAttribute = c, r.getQuery = d, r.watchResponsiveAttributes = l, r
        }
        ...
        angular.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$window", "$mdConstant", function (t, n, r, o, a, i) {
            ...
            return c = {
                ...
                clientRect: function (e, t, n) {
                    var r = d(e);
                    t = d(t || r.offsetParent || document.body);
                    ...
                    return {left: o.left - a.left, top: o.top - a.top, width: o.width, height: o.height}
                },
                ...
                debounce: function (e, t, n, o) {
                    var a;
                    return function () {
                        var i = n, d = Array.prototype.slice.call(arguments);
                ...
                throttle: function (e, t) {
                    var n;
                    return function () {
                        var r = this, o = arguments, a = c.now();
                ...
                extractElementByName: function (e, t) {
                    for (var n = 0, r = e.length; r > n; n++)if (e[n].nodeName.toLowerCase() === t)return angular.element(e[n]);
                    return e
                }
            }
 ...
 */
    function () {
        ...
        function e(e, t, n) {
            function r(e, n, r) {
                var o = e[0];
                !o || o.hasAttribute(n) && 0 !== o.getAttribute(n).length || d(o, n) || (r = angular.isString(r) ? r.trim() : "", r.length ? e.attr(n, r) : t.warn('ARIA: Attribute "', n, '", required for accessibility, is missing on node:', o))
            }
            ...
            function d(e, t) {
                ...
                if (o)for (var i = e.childNodes, d = 0; d < i.length; d++) {
                    var c = i[d];
    ...
    function () {
        ...
        function e(e, t, n, r, o, a) {
            this.compile = function (i) {
                var d = i.templateUrl, c = i.template || "", l = i.controller, s = i.controllerAs, m = i.resolve || {}, u = i.locals || {}, f = i.transformTemplate || angular.identity, p = i.bindToController;
                return angular.forEach(m, function (e, t) {
                    m[t] = angular.isString(e) ? n.get(e) : n.invoke(e)
                }), angular.extend(m, u), m.$template = d ? t.get(d, {cache: a}).then(function (e) {
                    return e.data
                }) : e.when(c), e.all(m).then(function (e) {
 ...
 */
    function () {
        ...
        function e(e, t, n) {
            ...
            function o(t, n) {
                var r = new e(t);
                return angular.extend(r, n), s[t] = r, u
            }

            var d = navigator.userAgent || navigator.vendor || window.opera, c = d.match(/iPad/i) || d.match(/iPhone/i) || d.match(/iPod/i), l = d.match(/Android/i), m = c || l, u = {
                handler: o,
                register: r
            };
            return (u.$$hijackClicks = m) && u.handler("click", {
                ...
                options: {minDistance: 6, horizontal: !0}, onStart: function () {
                    ...
                    var n, r;
                    e.preventDefault(), this.state.dragPointer ? this.dispatchDragMove(e) : (this.state.options.horizontal ? (n = Math.abs(t.distanceX) > this.state.options.minDistance, r = Math.abs(t.distanceY) > 1.5 * this.state.options.minDistance) : (n = Math.abs(t.distanceY) > this.state.options.minDistance, r = Math.abs(t.distanceX) > 1.5 * this.state.options.minDistance), n ? (this.state.dragPointer = a(e), i(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragstart", this.state.dragPointer)) : r && this.cancel())
        ...
        function n() {
            ...
            return t.prototype = {
                ...
                options: {},
                dispatchEvent: "undefined" != typeof window.jQuery && angular.element === window.jQuery ? e : n,
                start: function (e, t) {
        ...
        function r(e) {
            function n(e, n) {
                var r;
                for (var o in s)r = s[o], r instanceof t && ("start" === e && angular.isFunction(r.cancel) && r.cancel(), r[e](n, c))
            }

            function r(e) {
                if (!c) {
                    var t = +Date.now();
                    l && !o(e, l) && t - l.endTime < 1500 || (c = a(e), n("start", e))
                }
            }

            function d(e) {
                c && o(e, c) && (i(e, c), n("move", e))
            }

            function m(e) {
                c && o(e, c) && (i(e, c), c.endTime = +Date.now(), n("end", e), l = c, c = null)
            }

            var u = "mousedown touchstart pointerdown", f = "mousemove touchmove pointermove", p = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
            document.contains || (document.contains = function (e) {
                return document.body.contains(e)
            }), e.$$hijackClicks && document.addEventListener("click", function (e) {
                var t = 0 === e.clientX && 0 === e.clientY;
                t || e.$material || (e.preventDefault(), e.stopPropagation())
            }, !0), angular.element(document).on(u, r).on(f, d).on(p, m).on("$$mdGestureReset", function () {
                l = c = null
            })
        }
        ...
        function a(e) {
            var t = d(e), n = {startTime: +Date.now(), target: e.target, type: e.type.charAt(0)};
            return n.startX = n.x = t.pageX, n.startY = n.y = t.pageY, n
        }

        function i(e, t) {
            var n = d(e), r = t.x = n.pageX, o = t.y = n.pageY;
        ...
        var c, l, s = {};
        angular.module("material.core.gestures", []).factory("$mdGesture", e).factory("$$MdGestureHandler", n).run(r), e.$inject = ["$$MdGestureHandler", "$$rAF", "$timeout"], n.$inject = ["$$rAF"], r.$inject = ["$mdGesture"]
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        ...
        function e() {
            function e(e) {
                function t(e) {
                    return d.optionsFactory = e.options, d.methods = (e.methods || []).concat(a), c
                }
                ...
                function o(t, n, r) {
                    ...
                    var c, l, s = t(), m = {hide: s.hide, cancel: s.cancel, show: o};
                    return c = d.methods || [], l = a(d.optionsFactory, {}), angular.forEach(i, function (e, t) {
                        m[t] = e
                    }), angular.forEach(d.presets, function (e, t) {
                        function n(e) {
                            this._options = angular.extend({}, r, e)
                        }

                        var r = a(e.optionsFactory, {}), o = (e.methods || []).concat(c);
                ...
                var a = ["onHide", "onShow", "onRemove"], i = {}, d = {presets: {}}, c = {
                    setDefaults: t,
                    addPreset: r,
                    addMethod: n,
                    $get: o
                };
                return c.addPreset("build", {methods: ["controller", "controllerAs", "resolve", "template", "templateUrl", "themable", "transformTemplate", "parent"]}), o.$inject = ["$$interimElement", "$animate", "$injector"], c
            }
                    ...
                    function m(i) {
                        ...
                        return i = i || {}, i = angular.extend({
                            ...
                            show: function () {
                                ...
                                }) : d.compile(i), p = n.then(function (n) {
                                    function a() {
                                        i.hideDelay && (s = r(u.cancel, i.hideDelay))
                                    }

                                    angular.extend(n.locals, l.options), m = n.link(i.scope), angular.isFunction(i.parent) ? i.parent = i.parent(i.scope, m, i) : angular.isString(i.parent) && (i.parent = angular.element(e[0].querySelector(i.parent))), (i.parent || {}).length || (i.parent = o.find("body"), i.parent.length || (i.parent = o)), i.themable && c(m);
                                    var d = i.onShow(i.scope, m, i);
        ...
        function t(e, t) {
            ...
            function a(n, r, o) {
                ...
                function l(n, d) {
                    ...
                    function s(e, t) {
                        var n, r, a, i = u.prop("offsetWidth"), d = u.prop("offsetHeight");
                        return o.isMenuItem ? r = Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2)) : o.outline ? (a = M.getBoundingClientRect(), e -= a.left, t -= a.top, i = Math.max(e, i - e), d = Math.max(t, d - t), r = 2 * Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2))) : (n = o.fullRipple ? 1.1 : .8, r = Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2)) * n, o.fitRipple && (r = Math.min(d, i, r))), r
                    }
                    ...
                    function m(e, t, n) {
                        ...
                        var a = M.getBoundingClientRect(), i = {
                            backgroundColor: r(T),
                            borderColor: r(T),
                            width: e + "px",
                            height: e + "px"
                        };
                        return o.outline ? (i.width = 0, i.height = 0) : i.marginLeft = i.marginTop = e * -.5 + "px", o.center ? i.left = i.top = "50%" : (i.left = Math.round((t - a.left) / u.prop("offsetWidth") * 100) + "%", i.top = Math.round((n - a.top) / u.prop("offsetHeight") * 100) + "%"), i
                    }

                    T = i(r.attr("md-ink-ripple")) || i(e.getComputedStyle(o.colorElement[0]).color || "rgb(0, 0, 0)");
                    var u = a(), p = s(n, d), v = m(p, n, d), E = l(v), $ = g.indexOf(E), A = b[$] || {};
                    return f = p, A.animating = !0, t(function () {
                        o.dimBackground && u.css({backgroundColor: T}), E.addClass("md-ripple-placed md-ripple-scaled"), o.outline ? E.css({
                            ...
                            marginLeft: p * -.5 + "px",
                            marginTop: p * -.5 + "px"
                        }) : E.css({left: "50%", top: "50%"}), c(E), t(function () {
                            A.animating = !1, c(E)
                        }, o.outline ? 450 : 225, !1)
                    }, 0, !1), E
                }
                ...
                var f, p = r.controller("mdInkRipple") || {}, h = 0, g = [], b = [], v = r.attr("md-highlight"), E = !1, $ = !1, M = r[0], A = r.attr("md-ripple-size"), T = i(r.attr("md-ink-ripple")) || i(o.colorElement.length && e.getComputedStyle(o.colorElement[0]).color || "rgb(0, 0, 0)");
                switch (A) {
                    case"full":
                        o.fullRipple = !0;
                        break;
 ...
 */
    function () {
        ...
        function e(e) {
            ...
            function m(e, t) {
                ...
                return r.inherit = function (r, o) {
                    ...
                    var i = o.controller("mdTheme"), d = r.attr("md-theme-watch");
            ...
            c = {}, l = {};
            var g = "default", b = !1;
            return angular.extend(c, e), m.$inject = ["$rootScope", "$log"], s = {
                definePalette: t,
                extendPalette: n,
                theme: a,
        ...
        function r(e, t, n) {
            ...
            var r = [], o = e.colors[t], i = new RegExp(".md-" + e.name + "-theme", "g"), l = new RegExp("('|\")?{{\\s*(" + t + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"), s = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?\s*\}\}'?"?/g, m = c[o.name];
            return n = n.replace(s, function (t, n, r, o) {
                ...
                var a = n.replace(l, function (e, n, r, o, a) {
                    return d(m[t]["color" === o ? "value" : "contrast"], a)
                });
        ...
        function o(e) {
            function t(e) {
                ...
                "string" == typeof n && (n = n.split(" ")), "string" == typeof r && (r = r.split(" ")), "string" == typeof o && (o = o.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, angular.forEach(e, function (a, d) {
                    function c() {
                        return "light" === t ? o.indexOf(d) > -1 ? g : r.indexOf(d) > -1 ? v : b : n.indexOf(d) > -1 ? r.indexOf(d) > -1 ? v : b : g
                    }
            ...
            var d = new RegExp("md-(" + E.join("|") + ")", "g");
            o.forEach(function (e) {
                for (var t, n = (e.match(d), 0); t = E[n]; n++)if (e.indexOf(".md-" + t) > -1)return a[t] += e;
 ...
 */
    function () {
        ...
        function t(e) {
            function t(e, t, o, a, i, d, c, l, s) {
                function m(n, r, s) {
                    r = o.extractElementByName(r, "md-bottom-sheet"), p = i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(n), p.on("click", function () {
                        a(c.cancel)
                    }), d.inherit(p, s.parent), e.enter(p, s.parent, null);
                    var m = new f(r, s.parent);
                    return s.bottomSheet = m, s.targetEvent && angular.element(s.targetEvent.target).blur(), d.inherit(m.element, s.parent), s.disableParentScroll && (s.lastOverflow = s.parent.css("overflow"), s.parent.css("overflow", "hidden")), e.enter(m.element, s.parent).then(function () {
                        ...
                        e.focus(), s.escapeToClose && (s.rootElementKeyupCallback = function (e) {
                            e.keyCode === t.KEY_CODE.ESCAPE && a(c.cancel)
                ...
                function u(t, n, r) {
                    var o = r.bottomSheet;
                    return e.leave(p), e.leave(o.element).then(function () {
                ...
                function f(e, o) {
                    ...
                    function l(r) {
                        if (r.pointer.distanceY > 0 && (r.pointer.distanceY > 20 || Math.abs(r.pointer.velocityY) > n)) {
                            var o = e.prop("offsetHeight") - r.pointer.distanceY, i = Math.min(o / r.pointer.velocityY * .75, 500);
                            e.css(t.CSS.TRANSITION_DURATION, i + "ms"), a(c.cancel)
                        } else e.css(t.CSS.TRANSITION_DURATION, ""), e.css(t.CSS.TRANSFORM, "")
                    }

                    var m = s.register(o, "drag", {horizontal: !1});
                    return o.on("$md.dragstart", i).on("$md.drag", d).on("$md.dragend", l), {
                        element: e,
                        cleanup: function () {
                            m(), o.off("$md.dragstart", i).off("$md.drag", d).off("$md.dragend", l)
                        }
                    }
                }
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a) {
            function i(t, i) {
                return i.type = "checkbox", i.tabIndex = 0, t.attr("role", i.type), function (t, i, c, l) {
                    function s(e) {
                    ...
                    l = l || a.fakeNgModel();
                    var f = !1;
                    o(i), c.ngChecked && t.$watch(t.$eval.bind(t, c.ngChecked), l.$setViewValue.bind(l)), n.expectWithText(i, "aria-label"), e.link.pre(t, {
                        on: angular.noop,
                        0: {}
                    }, c, [l]), i.on("click", m).on("keypress", s), l.$render = u
                }
            }
 ...
 */
    function () {
        "use strict";
        angular.module("material.components.chips", ["material.core"])
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        ...
        function t(e) {
            ...
            function n(e, t, n, r, o, a, i, d, c, l, s) {
                function m(e) {
                ...
                function u(e, l, s) {
                    function u() {
                        ...
                        if (!e) {
                            var t = l[0].querySelectorAll(".md-actions button");
                            e = t[t.length - 1]
                        }
                        return angular.element(e)
                    }

                    l = n.extractElementByName(l, "md-dialog"), s.parent = angular.element(s.parent), s.popInTarget = angular.element((s.targetEvent || {}).target);
                    var f = u();
                    if (s.hasBackdrop) {
                        var h = s.parent[0] == t[0].body && t[0].documentElement && t[0].documentElement.scrollTop ? angular.element(t[0].documentElement) : s.parent, v = h.prop("scrollTop");
                        s.backdrop = angular.element('<md-backdrop class="md-dialog-backdrop md-opaque">'), s.backdrop.css("top", v + "px"), o.inherit(s.backdrop, s.parent), c.enter(s.backdrop, s.parent), l.css("top", v + "px")
                    }
                    var E = "dialog", $ = f;
                    return "alert" === s.$type && (E = "alertdialog", $ = l.find("md-content")), p(l.find("md-dialog"), E, s), document.addEventListener("focus", m, !0), s.disableParentScroll && (s.lastOverflow = s.parent.css("overflow"), s.parent.css("overflow", "hidden")), b(l, s.parent, s.popInTarget && s.popInTarget.length && s.popInTarget).then(function () {
                        g(l, !0), s.escapeToClose && (s.rootElementKeyupCallback = function (e) {
                            e.keyCode === r.KEY_CODE.ESCAPE && i(a.cancel)
                        }, d.on("keyup", s.rootElementKeyupCallback)), s.clickOutsideToClose && (s.dialogClickOutsideCallback = function (e) {
                            e.target === l[0] && i(a.cancel)
                        }, l.on("click", s.dialogClickOutsideCallback)), s.focusOnOpen && $.focus()
                    })
                }

                function f(e, t, n) {
                    return n.backdrop && c.leave(n.backdrop), n.disableParentScroll && (n.parent.css("overflow", n.lastOverflow), delete n.lastOverflow), n.escapeToClose && d.off("keyup", n.rootElementKeyupCallback), n.clickOutsideToClose && t.off("click", n.dialogClickOutsideCallback), g(t, !1), document.removeEventListener("focus", m, !0), v(t, n.parent, n.popInTarget && n.popInTarget.length && n.popInTarget).then(function () {
                        n.scope.$destroy(), t.remove(), n.popInTarget && n.popInTarget.focus()
                    })
                }

                function p(t, r, o) {
                    t.attr({role: r, tabIndex: "-1"});
                    var a = t.find("md-content");
                    0 === a.length && (a = t);
                    var i = t.attr("id") || "dialog_" + n.nextUid();
                    a.attr("id", i), t.attr("aria-describedby", i), o.ariaLabel ? e.expect(t, "aria-label", o.ariaLabel) : e.expectAsync(t, "aria-label", function () {
                ...
                function g(e, t) {
                    function n(e) {
                        for (; e.parentNode;) {
                            ...
                            for (var o = e.parentNode.children, a = 0; a < o.length; a++)e === o[a] || h(o[a], ["SCRIPT", "STYLE"]) || o[a].setAttribute(r, t);
                            n(e = e.parentNode)
                        }
                    }
                ...
                function b(e, t, o) {
                    ...
                    return t.append(e), E(a, o), l(function () {
                        a.addClass("transition-in").css(r.CSS.TRANSFORM, "")
                    }), n.transitionEndPromise(a)
                }

                function v(e, t, r) {
                    var o = e.find("md-dialog");
                    return o.addClass("transition-out").removeClass("transition-in"), E(o, r), n.transitionEndPromise(o)
                }
    ...
    function () {
        ...
        function e(e, n, r, o) {
            function a(t, a, i, d) {
                ...
                function s(e) {
                    null == e ? d.invalidateLayout() : o(e) && d.invalidateLayout()
                }

                function m() {
                    var e = p(), n = g(), o = E(), i = v(), d = b(), c = r(n, h(), p()).map(function (t, r) {
                        return {
                            grid: {element: a, style: f(n, r, d, o, i)}, tiles: t.map(function (t, a) {
                                return {element: angular.element(e[a]), style: u(t.position, t.spans, n, r, d, o, i)}
                            })
                        }
                    }).reflow().performance();
                    t.mdOnLayout({$event: {performance: c}})
                }

                function u(e, t, n, r, o, a, i) {
                    var d = 1 / n * 100, c = (n - 1) / n, l = T({
                        share: d,
                        gutterShare: c,
                        gutter: o
                    }), s = {
                        left: w({unit: l, offset: e.col, gutter: o}),
                        width: y({unit: l, span: t.col, gutter: o}),
                        paddingTop: "",
                        marginTop: "",
                        top: "",
                        height: ""
                    ...
                    switch (a) {
                        case"fixed":
                            s.top = w({unit: i, offset: e.row, gutter: o}), s.height = y({
                                unit: i,
                                span: t.row,
                                gutter: o
                            });
                            break;
                        case"ratio":
                            var m = d / i, u = T({share: m, gutterShare: c, gutter: o});
                            s.paddingTop = y({unit: u, span: t.row, gutter: o}), s.marginTop = w({
                                unit: u,
                                offset: e.row,
                                gutter: o
                            });
                            break;
                        case"fit":
                            var f = (r - 1) / r, m = 1 / r * 100, u = T({share: m, gutterShare: f, gutter: o});
                            s.top = w({unit: u, offset: e.row, gutter: o}), s.height = y({
                                unit: u,
                                span: t.row,
                                gutter: o
                            })
                ...
                function f(e, t, n, r, o) {
                    ...
                    switch (r) {
                        case"fixed":
                            a.height = y({unit: o, span: t, gutter: n});
                            break;
                        case"ratio":
                            var i = 1 === e ? 0 : (e - 1) / e, d = 1 / e * 100, c = d * (1 / o), l = T({
                                share: c,
                                gutterShare: i,
                                gutter: n
                            });
                            a.paddingBottom = y({unit: l, span: t, gutter: n});
                            break;
                        case"fit":
                    }
                    return a
                ...
                a.attr("role", "list"), d.layoutDelegate = m;
                var M = angular.bind(d, d.invalidateLayout), A = c();
                t.$on("$destroy", l);
                var T = e("{{share}}% - ( {{gutter}} * {{gutterShare}} )"), w = e("calc( ( ({{unit}}) + {{gutter}} ) * {{offset}} "), y = e("calc(({{unit}}) * {{span}} + ({{span}} - 1) * {{gutter}})")
            }
        ...
        function n(e) {
            function t(t, n) {
                ...
                return c = e.time(function () {
                    ...
                    layoutInfo: function () {
                        ...
                        return {tileCount: n.length, layoutTime: c, mapTime: l, reflowTime: s, totalTime: c + l + s}
                    }
                }
            }
            ...
            function r(e, t) {
                function n(t, n) {
                    ...
                    for (var i = 0, s = 0; s - i < t.col;)d >= e ? r() : (i = l.indexOf(0, d), -1 !== i && -1 !== (s = a(i + 1)) ? d = s + 1 : (i = s = 0, r()));
                    return o(i, t.col, t.row), d = i + t.col, {col: i, row: c}
                }
        ...
        angular.module("material.components.gridList", ["material.core"]).directive("mdGridList", e).directive("mdGridTile", r).directive("mdGridTileFooter", o).directive("mdGridTileHeader", o).factory("$mdGridLayout", n), e.$inject = ["$interpolate", "$mdConstant", "$mdGridLayout", "$mdMedia"], t.$inject = ["$timeout"], t.prototype = {
    ...
    function () {
        ...
        function e(e, t, n) {
            ...
            function o(r, o, a) {
                ...
                t(o);
                var d = a.alt || r.fontIcon || r.svgIcon, c = a.$normalize(a.$attr.mdSvgIcon || a.$attr.mdSvgSrc || "");
                "" == a.alt || i() ? n.expect(o, "aria-hidden", "true") : (n.expect(o, "aria-label", d), n.expect(o, "role", "img")), c && a.$observe(c, function (t) {
 ...
 */
    function () {
        ...
        function n(e, t, n, r, o) {
            ...
            function i(t) {
                var r = e[t];
                return r ? c(r.url).then(function (e) {
                    return new u(e, r)
                }) : n.reject(t)
            }
            ...
            function d(t) {
                ...
                return a ? c(a.url).then(r) : n.reject(t)
            }
            ...
            function f() {
                ...
                }, this), angular.forEach({"pointer-events": "none", display: "block"}, function (e, t) {
            ...
            return u.prototype = {clone: p, prepare: f}, function (e) {
                return e = e || "", h[e] ? n.when(h[e].clone()) : g.test(e) ? c(e).then(a(e)) : (-1 == e.indexOf(":") && (e = "$default:" + e), i(e).catch(d).catch(l).catch(s).then(a(e)))
            }
        }
    ...
    function () {
        ...
        function n(e, t) {
            function n(n, r, o, a) {
                ...
                function c() {
                    ...
                    function a() {
                        c.style.height = "auto", c.scrollTop = 0;
                        var e = i();
                        e && (c.style.height = e + "px")
                    }

                    function i() {
                        var e = c.scrollHeight - c.offsetHeight;
                        return c.offsetHeight + (e > 0 ? e : 0)
                    }
                    ...
                    var c = r[0], l = e.debounce(a, 1);
                    s ? (s.$formatters.push(o), s.$viewChangeListeners.push(o)) : l(), r.on("keydown input", l), r.on("scroll", d), angular.element(t).on("resize", l), n.$on("$destroy", function () {
                ...
                if (l) {
                    ...
                    n.$watch(u, l.setInvalid), s.$parsers.push(i), s.$formatters.push(i), r.on("input", d), m || r.on("focus", function () {
                        l.setFocused(!0)
                    }).on("blur", function () {
                        l.setFocused(!1), d()
        ...
        function r(e) {
            function t(t, n, r, o) {
                ...
                var i, d = o[0], c = o[1], l = angular.element('<div class="md-char-counter">');
 ...
 */
    function () {
        ...
        function e(e, t) {
            ...
            function r(n, r, a) {
                t(r);
                var i = r[0], d = a.mdDiameter || 48, c = d / 48;
                i.style[e.CSS.TRANSFORM] = "scale(" + c + ")", a.$observe("value", function (e) {
                    var t = o(e);
                    r.attr("aria-valuenow", t)
                })
            }
 ...
 */
    function () {
        ...
        function e(e, n, r) {
            ...
            function a(o, a, d) {
                r(a);
                var c = a[0].querySelector(".md-bar1").style, l = a[0].querySelector(".md-bar2").style, s = angular.element(a[0].querySelector(".md-container"));
    ...
    function () {
        ...
        function e(e, t, n) {
            function r(r, o, a, i) {
                ...
                n(o);
                var c = i[0], l = i[1] || e.fakeNgModel();
                c.init(l), o.attr({role: "radiogroup", tabIndex: o.attr("tabindex") || "0"}).on("keydown", d)
            }
        ...
        function t(e, t, n) {
            function r(r, a, i, d) {
                ...
                function l() {
                    ...
                    e !== m && (m = e, a.attr("aria-checked", e), e ? (a.addClass(o), d.setActiveDescendant(a.attr("id"))) : a.removeClass(o))
                }
                ...
                var m;
                n(a), s(a, r), d.add(l), i.$observe("value", l), a.on("click", c).on("$destroy", function () {
                    d.remove(l)
                })
            }
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a) {
            function i(r, i) {
                var d = r.find("md-select-label").remove();
                if (d.length) {
                    if (!d[0].firstElementChild) {
                        var c = angular.element("<span>");
                        c.append(d.contents()), d.append(c)
                    }
                } else d = angular.element("<md-select-label><span></span></md-select-label>");
                d.append('<span class="md-select-icon" aria-hidden="true"></span>'), d.addClass("md-select-label"), d.attr("id", "select_label_" + t.nextUid()), r.find("md-content").length || r.append(angular.element("<md-content>").append(r.contents())), i.mdOnOpen && r.find("md-content").prepend(angular.element("<md-progress-circular>").attr("md-mode", "indeterminate").attr("ng-hide", "$$loadingAsyncDone").wrap("<div>").parent());
                var l = '<div class="md-select-menu-container"><md-select-menu ' + (angular.isDefined(i.multiple) ? "multiple" : "") + ">" + r.html() + "</md-select-menu></div>";
                return r.empty().append(d), n(r), function (n, r, i, d) {
                    function c() {
                        if (h) {
                            var e = h.find("md-select-menu").controller("mdSelectMenu");
                            v.setLabelText(e.selectedLabels())
                        }
                    }

                    function s() {
                        h = angular.element(l);
                        var e = h.find("md-select-menu");
                        e.data("$ngModelController", E), e.data("$mdSelectController", v), g = n.$new(), h = o(h)(g), b = h.find("md-select-menu").controller("mdSelectMenu")
                    }

                    function m(e) {
                        var t = [32, 13, 38, 40];
                        if (-1 != t.indexOf(e.keyCode))e.preventDefault(), u(e); else if (e.keyCode <= 90 && e.keyCode >= 31) {
                            e.preventDefault();
                            var n = b.optNodeForKeyboardSearch(e);
                            if (!n)return;
                            var r = angular.element(n).controller("mdOption");
                            b.isMultiple || b.deselect(Object.keys(b.selected)[0]), b.select(r.hashKey, r.value), b.refreshViewValue(), E.$render()
                        }
                    }
                    ...
                    function u() {
                        n.$evalAsync(function () {
                            f = !0, e.show({
                                ...
                                target: r[0],
                                hasBackdrop: !0,
                                loadingAsync: i.mdOnOpen ? n.$eval(i.mdOnOpen) : !1
                            }).then(function () {
                                f = !1
                            })
                        })
                    ...
                    var f, p, h, g, b, v = d[0], E = d[1], $ = r.find("md-select-label"), M = 0 !== $.text().length;
                    s();
                    var A = E.$render;
                    E.$render = function () {
                        A(), c()
                        ...
                        if (!M) {
                            ...
                            var t = e || i.placeholder || "", n = M ? $ : $.children().eq(0);
                            n.text(t)
                        }
                    ...
                    i.$observe("ngMultiple", function (e) {
                        ...
                        T = n.$watch(function () {
                            ...
                            (void 0 !== e || void 0 !== t) && (e ? r.attr("multiple", "multiple") : r.removeAttr("multiple"), h && (b.setMultiple(e), A = E.$render, E.$render = function () {
                                A(), c()
                            }, b.refreshViewValue(), E.$render()))
                        })
                    }), i.$observe("disabled", function (e) {
                        "string" == typeof e && (e = !0), (void 0 === p || p !== e) && (p = e, e ? (r.attr("tabindex", -1), r.off("click", u), r.off("keydown", m)) : (r.attr("tabindex", 0), r.on("click", u), r.on("keydown", m)))
                    }), i.disabled || i.ngDisabled || (r.attr("tabindex", 0), r.on("click", u), r.on("keydown", m)), r.attr({
                        role: "combobox",
            ...
            return {
                restrict: "E", require: ["mdSelect", "ngModel"], compile: i, controller: function () {
                }
            }
        }
        ...
        function t(e, t, n) {
            function r(e, r, o, a) {
                ...
                var l = a[0], s = a[1];
                n(r), r.on("click", c), r.on("keypress", d), s && l.init(s), i()
            }
            ...
            function o(t, n, r) {
                function o() {
                    ...
                    if (angular.isArray(e)) {
                        var t = Object.keys(c.selected), n = e.map(c.hashGetter), r = t.filter(function (e) {
                            return -1 === n.indexOf(e)
                        });
                        r.forEach(c.deselect), n.forEach(function (t, n) {
                            c.select(t, e[n])
                        })
                    }
                }
                ...
                var c = this;
                c.isMultiple = angular.isDefined(n.multiple), c.selected = {}, c.options = {};
                var l;
                c.setMultiple = function (e) {
                    ...
                    var a = c.ngModel;
                    c.isMultiple = e, l && l(), c.isMultiple ? (a.$validators["md-multiple"] = r, a.$render = o, t.$watchCollection(n.ngModel, function (e) {
                        r(e) && o(e)
                    })) : (delete a.$validators["md-multiple"], a.$render = i)
                };
                var s, m, u, f = "", p = 300;
                c.optNodeForKeyboardSearch = function (e) {
                    s && clearTimeout(s), s = setTimeout(function () {
                        s = void 0, f = "", u = void 0, m = void 0
                    }, p), f += String.fromCharCode(e.keyCode);
                    var t = new RegExp("^" + f, "i");
                    m || (m = r.find("md-option"), u = new Array(m.length), angular.forEach(m, function (e, t) {
                        u[t] = e.textContent
                    }));
                    for (var n = 0; n < u.length; ++n)if (t.test(u[n]))return m[n]
                }, c.init = function (n) {
                    if (c.ngModel = n, n.$options && n.$options.trackBy) {
                        var r = {}, o = e(n.$options.trackBy);
                        c.hashGetter = function (e, n) {
                            return r.$value = e, o(n || t, r)
                        }
                    } else c.hashGetter = function (e) {
                        return angular.isObject(e) ? "$$object_" + (e.$$mdSelectId || (e.$$mdSelectId = ++d)) : e
                    };
                    ...
                    if (angular.isDefined(c.options[e]))throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "' + t.value + '" found.');
                    c.options[e] = t, angular.isDefined(c.selected[e]) && (c.select(e, t.value), c.refreshViewValue())
        ...
        function n(e, t) {
            ...
            function r(n, r, o, a) {
                function i(e, t) {
                    ...
                    c.hashKey = o, c.value = e, l.removeOption(r, c), l.addOption(o, c)
                }
                ...
                o.$observe("selected", function (e) {
                    angular.isDefined(e) && (e ? (l.isMultiple || l.deselect(Object.keys(l.selected)[0]), l.select(c.hashKey, c.value)) : l.deselect(c.hashKey), l.refreshViewValue(), l.ngModel.$render())
                }), e.attachButtonBehavior(n, r), d(), n.$on("$destroy", function () {
        ...
        function o(e) {
            function t(e, t, o, d, c, l) {
                function s(n, r, i) {
                        ...
                        if (!i.isRemoved) {
                            ...
                            r.addClass("md-clickable"), i.backdrop && i.backdrop.on("click", function (t) {
                                ...
                                switch (r.keyCode) {
                                    ...
                                    case t.KEY_CODE.ENTER:
                                        var o = d.getClosest(r.target, "md-option");
                            ...
                            }), i.selectEl.on("click", s), i.selectEl.on("keydown", function (e) {
                    ...
                    }), i.disableParentScroll && (i.disableTarget = i.parent.find("md-content"), i.disableTarget.length || (i.disableTarget = i.parent), i.lastOverflow = i.disableTarget.css("overflow"), i.disableTarget.css("overflow", "hidden")), l(m, 75, !1), i.backdrop && (c.inherit(i.backdrop, i.parent), i.parent.append(i.backdrop)), i.parent.append(r), o(function () {
                        o(function () {
                            i.isRemoved || u(n, r, i)
                        })
                    }), d.transitionEndPromise(i.selectEl, {timeout: 350})
                }

                function m(e, t, n) {
                    n.isRemoved = !0, t.addClass("md-leave").removeClass("md-clickable"), n.target.attr("aria-expanded", "false"), n.disableParentScroll && d.floatingScrollbars() && (n.disableTarget.css("overflow", n.lastOverflow), delete n.lastOverflow, delete n.disableTarget);
                    var r = n.selectEl.controller("mdSelect");
                    return r && r.setLabelText(n.selectEl.controller("mdSelectMenu").selectedLabels()), d.transitionEndPromise(t, {timeout: 350}).then(function () {
                        t.removeClass("md-active"), n.parent[0].removeChild(t[0]), n.backdrop && n.backdrop.remove(), n.restoreFocus && n.target.focus()
                    })
                }

                function u(e, a, d) {
                    var c, l = a[0], s = d.target[0], m = d.parent[0], u = d.selectEl[0], f = d.contentEl[0], p = m.getBoundingClientRect(), h = s.getBoundingClientRect(), g = !1, b = {
                        left: p.left + i,
                        top: i,
                        bottom: p.height - i,
                        right: p.width - i
                        ...
                        top: h.top - b.top,
                        left: h.left - b.left,
                        right: b.right - (h.left + h.width),
                        bottom: b.bottom - (h.top + h.height)
                    }, E = p.width - 2 * i, $ = f.scrollHeight > f.offsetHeight, M = u.querySelector("md-option[selected]"), A = u.getElementsByTagName("md-option"), T = u.getElementsByTagName("md-optgroup");
                    c = M ? M : T.length ? T[0] : A.length ? A[0] : f.firstElementChild || f, f.offsetWidth > E && (f.style["max-width"] = E + "px"), g && (f.style["min-width"] = h.width + "px"), $ && u.classList.add("md-overflow");
                    var w = u.getBoundingClientRect(), y = r(c);
                    if (c) {
                        var C = window.getComputedStyle(c);
                        y.paddingLeft = parseInt(C.paddingLeft, 10) || 0, y.paddingRight = parseInt(C.paddingRight, 10) || 0
                    }
                    var k = c;
                    if ("MD-OPTGROUP" === (k.tagName || "").toUpperCase() && (k = A[0] || f.firstElementChild || f), $) {
                        var x = f.offsetHeight / 2;
                        f.scrollTop = y.top + y.height / 2 - x, v.top < x ? f.scrollTop = Math.min(y.top, f.scrollTop + x - v.top) : v.bottom < x && (f.scrollTop = Math.max(y.top + y.height - w.height, f.scrollTop - x + v.bottom))
                    }
                    var N, _, S;
                    g ? (N = h.left, _ = h.top + h.height, S = "50% 0", _ + w.height > b.bottom && (_ = h.top - w.height, S = "50% 100%")) : (N = h.left + y.left - y.paddingLeft, _ = h.top + h.height / 2 - y.height / 2 - y.top + f.scrollTop, S = y.left + h.width / 2 + "px " + (y.top + y.height / 2 - f.scrollTop) + "px 0px", l.style.minWidth = h.width + y.paddingLeft + y.paddingRight + "px");
                    var H = l.getBoundingClientRect();
                    l.style.left = n(b.left, N, b.right - H.width) + "px", l.style.top = n(b.top, _, b.bottom - H.height) + "px", u.style[t.CSS.TRANSFORM_ORIGIN] = S, u.style[t.CSS.TRANSFORM] = "scale(" + Math.min(h.width / w.width, 1) + "," + Math.min(h.height / w.height, 1) + ")", o(function () {
                        a.addClass("md-active"), u.style[t.CSS.TRANSFORM] = "", k && (d.focusedNode = k, k.focus())
                    })
                }
                ...
                return {
                    ...
                    onRemove: m,
                    hasBackdrop: !0,
                    disableParentScroll: d.floatingScrollbars(),
                    themable: !0
                }
            }
 ...
 */
    function () {
        ...
        function t(e, t, n, r, o, a, i, d, c, l) {
            function s(s, m, u, f) {
                function p(e, n) {
                    s.isLockedOpen = e, e === n ? m.toggleClass("md-locked-open", !!e) : t[e ? "addClass" : "removeClass"](m, "md-locked-open"), y.toggleClass("md-locked-open", !!e)
                }

                function h(e) {
                    var n = m.parent();
                    return n[e ? "on" : "off"]("keydown", v), y[e ? "on" : "off"]("click", E), e && (M = l[0].activeElement), g(e), A = c.all([t[e ? "enter" : "leave"](y, n), t[e ? "removeClass" : "addClass"](m, "md-closed").then(function () {
                        s.isOpen && m.focus()
                    })])
                }
                ...
                function g(e) {
                    var t = m.parent();
                    e ? ($ = t.css("overflow"), t.css("overflow", "hidden")) : angular.isDefined($) && (t.css("overflow", $), $ = void 0)
                }

                function b(t) {
                    if (s.isOpen == t)return c.when(!0);
                    var n = c.defer();
                    return s.isOpen = t, e(function () {
                        A.then(function (e) {
                            s.isOpen || (M && M.focus(), M = null), n.resolve(e)
                        })
                    }, 0, !1), n.promise
                }
                ...
                var $, M = null, A = c.when(!0), T = n(u.mdIsLockedOpen), w = function () {
                    return T(s.$parent, {
                        $media: function (e) {
                            return r.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."), o(e)
                        }, $mdMedia: o
                    })
                }, y = i('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(s);
                m.on("$destroy", f.destroy), d.inherit(y, m), s.$watch(w, p), s.$watch("isOpen", h), f.$toggleOpen = b
            }
    ...
    function () {
        ...
        function e(e, t, n, r, o, a, i, d) {
            ...
            function l(n, c, l, s) {
                ...
                function u(e) {
                    W = parseFloat(e), c.attr("aria-valuemin", e), m()
                }

                function f(e) {
                    G = parseFloat(e), c.attr("aria-valuemax", e), m()
                }
                ...
                function g() {
                    if (angular.isDefined(l.mdDiscrete)) {
                        ...
                        for (var o, a = 0; e >= a; a++)o = Math.floor(r.width * (a / e)), Z.fillRect(o - 1, 0, 2, r.height)
                    }
                }

                function b() {
                    Q = F[0].getBoundingClientRect()
                }
                ...
                function E(e) {
                    if (!c[0].hasAttribute("disabled")) {
                        var t;
                        e.keyCode === o.KEY_CODE.LEFT_ARROW ? t = -z : e.keyCode === o.KEY_CODE.RIGHT_ARROW && (t = z), t && ((e.metaKey || e.ctrlKey || e.altKey) && (t *= 4), e.preventDefault(), e.stopPropagation(), n.$evalAsync(function () {
                            $(s.$viewValue + t)
                        }))
                    }
                }
                ...
                function M() {
                    ...
                    n.modelValue = s.$viewValue, c.attr("aria-valuenow", s.$viewValue), w(e), j.text(s.$viewValue)
                }

                function A(e) {
                    return angular.isNumber(e) ? Math.max(W, Math.min(G, e)) : void 0
                }
                ...
                function w(e) {
                    V.css("width", 100 * e + "%"), B.css("left", 100 * e + "%"), c.toggleClass("md-min", 0 === e)
                }

                function y(e) {
                    if (!L()) {
                        c.addClass("active"), c[0].focus(), b();
                        var t = D(I(e.pointer.x)), r = A(T(t));
                        n.$apply(function () {
                            $(r), w(O(r))
                        })
                    }
                ...
                function k(e) {
                    L() || (J = !0, e.stopPropagation(), c.addClass("dragging"), _(e))
                }
                ...
                var R = l.ngDisabled && d(l.ngDisabled), L = R ? function () {
                    return R(n.$parent)
                } : angular.noop, P = angular.element(c[0].querySelector(".md-thumb")), j = angular.element(c[0].querySelector(".md-thumb-text")), B = P.parent(), F = angular.element(c[0].querySelector(".md-track-container")), V = angular.element(c[0].querySelector(".md-track-fill")), q = angular.element(c[0].querySelector(".md-track-ticks")), U = r.throttle(b, 5e3);
                l.min ? l.$observe("min", u) : u(0), l.max ? l.$observe("max", f) : f(100), l.step ? l.$observe("step", p) : p(1);
                var Y = angular.noop;
                l.ngDisabled && (Y = n.$parent.$watch(l.ngDisabled, h)), i.register(c, "drag"), c.on("keydown", E).on("$md.pressdown", y).on("$md.pressup", C).on("$md.dragstart", k).on("$md.drag", x).on("$md.dragend", N), setTimeout(m);
                var K = e.throttle(m);
        ...
        function e(e, t, n, r, o) {
            function a(e) {
                ...
                function i() {
                    ...
                    i.prevScrollTop = e, 0 === e ? c(null) : t && f.next ? f.next.top - e <= 0 ? c(f.next) : f.current && (f.next.top - e <= f.next.height ? s(f.current, f.next.top - f.next.height - e) : s(f.current, null)) : !t && f.current && (e < f.current.top && c(f.prev), f.current && f.next && (e >= f.next.top - f.current.height ? s(f.current, f.next.top - e - f.current.height) : s(f.current, null)))
                }
                ...
                d(m), m.on("$scrollstart", u), m.on("$scroll", i);
            ...
            return function (e, t, n) {
                ...
                if (r)if (c)t.css({position: c, top: 0, "z-index": 2}); else {
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a, i, d) {
            function c(e, t) {
                var r = l.compile(e, t);
                return e.addClass("md-dragging"), function (e, t, c, l) {
                    function s(n) {
                    ...
                    l = l || n.fakeNgModel();
                    var p = a(c.ngDisabled), h = angular.element(t[0].querySelector(".md-thumb-container")), g = angular.element(t[0].querySelector(".md-container"));
                    i(function () {
                        t.removeClass("md-dragging")
                    }), r(e, t, c, l), angular.isDefined(c.ngDisabled) && e.$watch(p, function (e) {
                        t.attr("tabindex", e ? -1 : 0)
                    }), d.register(g, "drag"), g.on("$md.dragstart", s).on("$md.drag", m).on("$md.dragend", u);
                    var b
                }
            }
 ...
 */
    function () {
        ...
        function t(e) {
            function t(e, t, r, o) {
                function a(a, i, c) {
                    return i = o.extractElementByName(i, "md-toast"), n = c.content, i.addClass(c.position.split(" ").map(function (e) {
                        return "md-" + e
                    }).join(" ")), c.parent.addClass(d(c.position)), c.onSwipe = function (t) {
                        i.addClass("md-" + t.type.replace("$md.", "")), e(r.cancel)
                    }, i.on("$md.swipeleft $md.swiperight", c.onSwipe), t.enter(i, c.parent)
                }

                function i(e, n, r) {
                    return n.off("$md.swipeleft $md.swiperight", r.onSwipe), r.parent.removeClass(d(r.position)), t.leave(n)
                }
            ...
            return t.$inject = ["$timeout", "$animate", "$mdToast", "$mdUtil"], r
        }
        ...
        function e(e, t, n, r) {
            return {
                restrict: "E", controller: angular.noop, link: function (o, a, i) {
                    function d() {
                        function r(t, n) {
                            a.parent()[0] === n.parent()[0] && (s && s.off("scroll", p), n.on("scroll", p), n.attr("scroll-shrink", "true"), s = n, e(d))
                        }

                        function d() {
                            l = a.prop("offsetHeight"), s.css("margin-top", -l * f + "px"), c()
                        }
                        ...
                        var l, s, m = 0, u = 0, f = i.mdShrinkSpeedFactor || .5, p = e.throttle(c), h = n.debounce(d, 5e3);
    ...
    function () {
        ...
        function e(e, t, n, r, o, a, i, d, c) {
            function l(l, u, f) {
                ...
                function h() {
                    angular.isDefined(f.mdDelay) || (l.delay = s)
                }
                ...
                function g() {
                    l.$watch("visible", function (e) {
                        ...
                        l.visible = !1, u.remove(), angular.element(t).off("resize", S)
                    })
                }

                function b() {
                    u.detach(), u.attr("role", "tooltip"), u.attr("id", f.id || "tooltip_" + o.nextUid())
                }

                function v() {
                    for (var e = u.parent(); "none" == t.getComputedStyle(e[0])["pointer-events"];)e = e.parent();
                    return e
                }
                ...
                function $() {
                    var e = l.hasOwnProperty("autohide") ? l.autohide : f.hasOwnProperty("mdAutohide");
                    y.on("focus mouseenter touchstart", function () {
                        M(!0)
                    }), y.on("blur mouseleave touchend touchcancel", function () {
                        (r[0].activeElement !== y[0] || e) && M(!1)
                    }), angular.element(t).on("resize", S)
                }
                ...
                function A() {
                    y.attr("aria-describedby", u.attr("id")), _.append(u), w(), angular.forEach([u, C, k], function (e) {
                        d.addClass(e, "md-show")
                    })
                }

                function T() {
                    y.removeAttr("aria-describedby"), c.all([d.removeClass(k, "md-show"), d.removeClass(C, "md-show"), d.removeClass(u, "md-show")]).then(function () {
                        l.visible || u.detach()
                    })
                }
                ...
                function w() {
                    function e() {
                        var e = "left" === x || "right" === x ? 2 * Math.sqrt(Math.pow(r.width, 2) + Math.pow(r.height / 2, 2)) : 2 * Math.sqrt(Math.pow(r.width / 2, 2) + Math.pow(r.height, 2)), t = "left" === x ? {
                            left: 100,
                            top: 50
                        } : "right" === x ? {left: 0, top: 50} : "top" === x ? {left: 50, top: 100} : {
                            left: 50,
                            top: 0
                        };
                        C.css({width: e + "px", height: e + "px", left: t.left + "%", top: t.top + "%"})
                    }
                    ...
                    var r = o.offsetRect(u, _), a = o.offsetRect(y, _), i = n(x);
                    x ? i = t(i) : i.top > u.prop("offsetParent").scrollHeight - r.height - m && (i = t(n("top"))), u.css({
                        top: i.top + "px",
                        left: i.left + "px"
                    }), e()
                }
                ...
                a(u);
                var y = v(), C = angular.element(u[0].getElementsByClassName("md-background")[0]), k = angular.element(u[0].getElementsByClassName("md-content")[0]), x = f.mdDirection, N = E(), _ = angular.element(N || document.body), S = n.throttle(function () {
                    l.visible && w()
                });
                return p()
            }
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o) {
            ...
            function i() {
                e.autofocus && _.input.focus()
            }

            function d() {
                var t = parseInt(e.delay, 10) || 0;
                e.$watch("searchText", t ? n.debounce(f, t) : f), m(l), e.$watch("selectedItem", s)
            }

            function c() {
                _ = {main: t[0], ul: t[0].getElementsByTagName("ul")[0], input: t[0].getElementsByTagName("input")[0]}
            }

            function l(t, n) {
                t && (e.searchText = g(t)), e.itemChange && t !== n && e.itemChange(b(t))
            }

            function s(e, t) {
                for (var n = 0; n < D.length; ++n)D[n](e, t)
            }
            ...
            function f(t, n) {
                if (k.index = v(), (t || t !== n) && t !== g(e.selectedItem)) {
                    if (e.selectedItem = null, !t || t.length < Math.max(parseInt(e.minLength, 10), 1))return k.loading = !1, k.matches = [], k.hidden = E(), w(), void 0;
                    var r = t.toLowerCase();
                    S && S.cancel && (S.cancel(), S = null), !e.noCache && H[r] ? (k.matches = H[r], w()) : T(t), k.hidden = E(), e.textChange && t !== n && e.textChange(b(e.selectedItem))
                }
            }
            ...
            function h(e) {
                switch (e.keyCode) {
                    case r.KEY_CODE.DOWN_ARROW:
                        if (k.loading)return;
                        e.preventDefault(), k.index = Math.min(k.index + 1, k.matches.length - 1), C(), y();
                        break;
                    case r.KEY_CODE.UP_ARROW:
                        if (k.loading)return;
                        e.preventDefault(), k.index = Math.max(0, k.index - 1), C(), y();
                        break;
                    case r.KEY_CODE.ENTER:
                        if (k.loading || k.index < 0)return;
                        e.preventDefault(), M(k.index);
                        break;
                    case r.KEY_CODE.ESCAPE:
                        k.matches = [], k.hidden = !0, k.index = v();
                        break;
                    case r.KEY_CODE.TAB:
                }
            }
            ...
            function g(t) {
                return t && e.itemText ? e.itemText(b(t)) : t
            }
            ...
            function E() {
                return 1 === k.matches.length && e.searchText === g(k.matches[0]) && e.selectedItem === k.matches[0]
            }

            function $() {
                return g(k.matches[k.index])
            }

            function M(t) {
                e.selectedItem = k.matches[t], e.searchText = g(e.selectedItem) || e.searchText, k.hidden = !0, k.index = 0, k.matches = []
            }

            function A() {
                e.searchText = "", M(-1), _.input.focus()
            }

            function T(t) {
                function n(n) {
                    H[o] = n, t === e.searchText && (S = null, k.loading = !1, k.matches = n, k.hidden = E(), w())
                }

                var r = e.$parent.$eval(N), o = t.toLowerCase();
                angular.isArray(r) ? n(r) : (k.loading = !0, r.success && r.success(n), r.then && r.then(n), r.error && r.error(function () {
                    k.loading = !1
                }))
            }

            function w() {
                if (!k.hidden)switch (k.matches.length) {
                    case 0:
                        return k.messages.splice(0);
                    case 1:
                        return k.messages.push({display: "There is 1 match available."});
                    default:
                        return k.messages.push({display: "There are " + k.matches.length + " matches available."})
                }
            }

            function y() {
                k.messages.push({display: $()})
            }

            function C() {
                var e = 41 * k.index, t = e + 41, n = 225.5;
                e < _.ul.scrollTop ? _.ul.scrollTop = e : t > _.ul.scrollTop + n && (_.ul.scrollTop = t - n)
            }

            var k = this, x = e.itemsExpr.split(/ in /i), N = x[1], _ = null, S = null, H = {}, I = !1, D = [];
            return k.scope = e, k.parent = e.$parent, k.itemName = x[0], k.matches = [], k.loading = !1, k.hidden = !0, k.index = null, k.messages = [], k.id = n.nextUid(), k.keydown = h, k.blur = p, k.clear = A, k.select = M, k.getCurrentDisplayValue = $, k.fetch = n.debounce(T), k.registerSelectedItemWatcher = m, k.unregisterSelectedItemWatcher = u, k.listEnter = function () {
                I = !0
        ...
        angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl", e), e.$inject = ["$scope", "$element", "$mdUtil", "$mdConstant", "$timeout"]
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        ...
        function e() {
            function e(e, t, n) {
                angular.forEach(e.$$isolateBindings, function (t, r) {
                    t.optional && angular.isUndefined(e[r]) && (e[r] = n.hasOwnProperty(n.$normalize(t.attrName)))
                })
            }
 ...
 */
    function () {
        ...
        function e(e, t) {
            function n(n, r, o, a) {
                var i = a.parent.$new(!1, a.parent), d = a.scope.$eval(o.mdAutocompleteListItem);
                i[d] = n.item, e(r.contents())(i), r.attr({role: "option", id: "item_" + t.nextUid()})
            }
    ...
    function () {
        ...
        function e() {
            function e(e, t) {
                return function () {
                    t.$apply(function () {
                        e.removeChip(t.$index)
                    })
                }
            }

            return {
                restrict: "A", require: ["^mdChips"], link: function (t, n, r, o) {
                    var a = o[0];
                    n.on("click", e(a, t))
                }, scope: !1
            }
        ...
        angular.module("material.components.chips").directive("mdChipRemove", e)
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        "use strict";
        function e(e, t, n) {
            this.$mdConstant = t, this.$log = n, this.ngModelCtrl = null, this.mdAutocompleteCtrl = null, this.items = [], this.selectedChip = -1, this.chipBuffer = "", this.useMdChipAppend = !1, this.hasInputElement = !1
        }

        angular.module("material.components.chips").controller("MdChipsCtrl", e), e.$inject = ["$mdUtil", "$mdConstant", "$log"], e.prototype.defaultInputKeydown = function (e) {
            switch (e.keyCode) {
                case this.$mdConstant.KEY_CODE.ENTER:
                    e.preventDefault(), this.appendChipBuffer();
                    break;
                case this.$mdConstant.KEY_CODE.BACKSPACE:
                    this.chipBuffer || (e.preventDefault(), this.removeChip(this.items.length - 1))
            }
        }, e.prototype.resetSelectedChip = function () {
            this.selectedChip = -1
        }, e.prototype.appendChipBuffer = function () {
            var e = this.getChipBuffer();
            this.useMdChipAppend && this.mdChipAppend && (e = this.mdChipAppend({$chip: e})), this.items.push(e), this.resetChipBuffer()
        }, e.prototype.useMdChipAppendExpression = function () {
            this.useMdChipAppend = !0
        }, e.prototype.getChipBuffer = function () {
            if (this.mdAutocompleteCtrl)this.$log.error("md-autocomplete not yet supported"); else {
                if (!this.hasInputElement)return this.chipBuffer;
                this.$log.error("user-provided inputs not yet supported")
            }
        }, e.prototype.resetChipBuffer = function () {
            this.mdAutocompleteCtrl ? this.$log.error("md-autocomplete not yet supported") : this.chipBuffer = ""
        }, e.prototype.removeChip = function (e) {
            this.items.splice(e, 1)
        }, e.prototype.selectChip = function (e) {
            e >= 0 && e <= this.items.length ? this.selectedChip = e : this.$log.warn("Selected Chip index out of bounds; ignoring.")
        ...
        }, e.prototype.configureMdAutocomplete = function (e) {
            this.mdAutocompleteCtrl = e
        }
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 ...
 */
    function () {
        ...
        function e(e, o) {
            function a(t, a) {
                var i = a.$mdUserTemplate, d = i.find("md-chip");
                0 === d.length ? d = angular.element(r) : d[0].querySelector("[md-chip-remove]") || o.warn("md-chip-remove attribute not found in md-chip template.");
                var c = angular.element(t[0].querySelector(".md-chip"));
                c.append(d);
                var l = i.find("md-autocomplete"), s = l.length > 0;
                if (!s) {
                    l = angular.element(n);
                    var m = angular.element(t[0].querySelector(".md-chip-worker"));
                    m.append(l)
                }
                return function (t, n, r, a) {
                    e(n);
                    var i = a[0], d = a[1];
                    d.configureNgModel(i), r.mdChipAppend && d.useMdChipAppendExpression(), s && o.error("md-autocomplete not yet supported")
                }
            }
            ...
            return {
                ...
                bindToController: !0,
                compile: a,
                scope: {readonly: "=readonly", placeholder: "@", secondaryPlaceholder: "@", mdChipAppend: "&"}
            }
        }

        angular.module("material.components.chips").directive("mdChips", e);
        var t = '      <md-chips-wrap ng-class="{readonly : $mdChipsCtrl.readonly}" class="md-chips">        <div role="presentation">          <div ng-repeat="$chip in $mdChipsCtrl.items"              ng-class="{selected: $mdChipsCtrl.selectedChip == $index}"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              class="md-chip">          </div>          <div ng-if="!$mdChipsCtrl.readonly" class="md-chip-worker"></div>        </div>      </md-chips-wrap>', n = '        <input            placeholder="{{$mdChipsCtrl.items.length == 0 ? $mdChipsCtrl.placeholder : $mdChipsCtrl.secondaryPlaceholder}}"            class="md-chip-input"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.resetSelectedChip()"            ng-keydown="$mdChipsCtrl.defaultInputKeydown($event)">', r = '      <md-chip>        <span>{{$chip}}</span>        <md-button ng-if="!$mdChipsCtrl.readonly"            md-chip-remove>x</md-button>      </md-chip>';
        e.$inject = ["$mdTheming", "$log"]
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        ...
        function e(e) {
            function t(t, n, r, o) {
                var a = t.$parent.$index;
                t.$watch("template", function (t) {
                    n.html(t), e(n.contents())(o.tabs[a].parent)
                })
            }

            return {restrict: "A", link: t, scope: {template: "=mdLabelTemplate"}, require: "^mdTabs"}
        }
 ...
 */
    function () {
        ...
        function e(e) {
            ...
            return {terminal: !0, scope: {tab: "=mdTabData", active: "=mdActive"}, link: t}
        }
 ...
 */
    function () {
        ...
        function e() {
            function e(e, t, n, r) {
                function o() {
                    return n.label || (t.find("md-tab-label")[0] || t[0]).innerHTML
                }

                function a() {
                    var e = t.find("md-tab-template");
                    return e.length ? e.html() : n.label ? t.html() : null
                }

                var i = t.parent()[0].getElementsByTagName("md-tab"), d = Array.prototype.indexOf.call(i, t[0]), c = r.insertTab({
                    scope: e,
                    parent: e.$parent,
                    index: d,
                    template: a(),
                ...
                e.$watch("active", function (e) {
                    ...
                    r.refreshIndex()
                }), e.$watch(a, function (e, t) {
                    e !== t && (c.template = e, r.updateInkBarStyles())
                }), e.$watch(o, function (e, t) {
                    e !== t && (c.label = e, r.updateInkBarStyles())
                }), e.$on("$destroy", function () {
                    r.removeTab(c)
                })
            }
            ...
            return {
                require: "^mdTabs",
                terminal: !0,
                scope: {label: "@", active: "=?mdActive", disabled: "=?ngDisabled"},
                link: e
            }
        }
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a, i) {
            function d() {
                e.$watch("selectedIndex", E), e.$watch("$mdTabsCtrl.focusIndex", u), e.$watch("$mdTabsCtrl.offsetLeft", m), angular.element(n).on("resize", function () {
                    e.$apply(h)
                }), r(A, 0, !1), r(M, 0, !1)
            }
            ...
            function l(t) {
                switch (t.keyCode) {
                    ...
                    case o.KEY_CODE.ENTER:
                        t.preventDefault(), e.selectedIndex = O.focusIndex
                }
                O.lastClick = !1
            }

            function s(t, n) {
                var r, o = n ? O.focusIndex : e.selectedIndex;
                for (r = o + t; O.tabs[r] && O.tabs[r].scope.disabled; r += t);
                O.tabs[r] && (n ? O.focusIndex = r : e.selectedIndex = r)
            }

            function m(t) {
                angular.element(R.paging).css("left", "-" + t + "px"), e.$broadcast("$mdTabsPaginationChanged")
            }
            ...
            function f() {
                R.dummies[O.focusIndex].focus()
            }

            function p() {
                var e = R.tabs[O.focusIndex], t = e.offsetLeft, n = e.offsetWidth + t;
                O.offsetLeft = Math.max(O.offsetLeft, N(n - R.canvas.clientWidth)), O.offsetLeft = Math.min(O.offsetLeft, N(t))
            }

            function h() {
                O.lastSelectedIndex = e.selectedIndex, M(), A(), O.offsetLeft = N(O.offsetLeft)
            }
            ...
            function g(n, r) {
                ...
                }, a = angular.extend(o, n);
                return n.template || (O.hasContent = !1, t.addClass("md-no-tab-content")), angular.isDefined(r) ? O.tabs.splice(r, 0, a) : O.tabs.push(a), a
            }

            function b(e) {
                O.tabs.splice(e.getIndex(), 1), v(), r(function () {
                    A(), O.offsetLeft = N(O.offsetLeft)
                })
            }

            function v() {
                e.selectedIndex = w(e.selectedIndex), O.focusIndex = w(O.focusIndex)
            }

            function E(t, n) {
                t !== n && (e.selectedIndex = w(t), O.lastSelectedIndex = n, A(), M(), e.$broadcast("$mdTabsChanged"))
            }

            function $() {
                $.watcher || ($.watcher = e.$watch(function () {
                    r(function () {
                        $.watcher && t.prop("offsetParent") && ($.watcher(), $.watcher = null, e.$apply(h))
                    }, 0, !1)
                }))
            }
            ...
            function M() {
                ...
                var n = R.contents[e.selectedIndex], r = n.offsetHeight, o = R.wrapper.offsetHeight, a = r + o;
                t.css("height", a + "px")
            }
            ...
            function A() {
                if (O.tabs.length) {
                    ...
                    var n = e.selectedIndex, r = R.paging.offsetWidth, o = R.tabs[n], a = o.offsetLeft, i = r - a - o.offsetWidth;
                    T(), angular.element(R.inkBar).css({left: a + "px", right: i + "px"})
                }
            }

            function T() {
                var t = e.selectedIndex, n = O.lastSelectedIndex, r = angular.element(R.inkBar);
                r.removeClass("md-left md-right"), angular.isNumber(n) && (n > t ? r.addClass("md-left") : t > n && r.addClass("md-right"))
            }

            function w(e) {
                var t, n, r = Math.max(O.tabs.length - e, e);
                for (t = 0; r >= t; t++) {
            ...
            function y() {
                switch (e.stretchTabs) {
                    ...
                    case"never":
                        return !1;
                    default:
                        return !C() && n.matchMedia("(max-width: 600px)").matches
                }
            }

            function C() {
                var e = t.prop("clientWidth");
                return angular.forEach(R.tabs, function (t) {
                    e -= t.offsetWidth
                }), 0 > e
            }

            function k(t) {
                O.focusIndex = e.selectedIndex = t, O.lastClick = !0
            }

            function x(e) {
                C() && (e.preventDefault(), O.offsetLeft = N(O.offsetLeft - e.wheelDelta))
            }

            function N(e) {
                var t = R.tabs[R.tabs.length - 1], n = t.offsetLeft + t.offsetWidth;
                return e = Math.max(0, e), e = Math.min(n - R.canvas.clientWidth, e)
            }

            function _() {
                var e, t, n = R.canvas.clientWidth, r = n + O.offsetLeft;
                for (e = 0; e < R.tabs.length && (t = R.tabs[e], !(t.offsetLeft + t.offsetWidth > r)); e++);
                O.offsetLeft = N(t.offsetLeft)
            }

            function S() {
                var e, t;
                for (e = 0; e < R.tabs.length && (t = R.tabs[e], !(t.offsetLeft + t.offsetWidth >= O.offsetLeft)); e++);
                O.offsetLeft = N(t.offsetLeft + t.offsetWidth - R.canvas.clientWidth)
            }
            ...
            function I() {
                var e = R.tabs[R.tabs.length - 1];
                return e && e.offsetLeft + e.offsetWidth > R.canvas.clientWidth + O.offsetLeft
            }

            function D(e, t) {
                var n = {colorElement: angular.element(R.inkBar)};
                a.attachTabBehavior(e, t, n)
            }
        ...
        angular.module("material.components.tabs").controller("MdTabsController", e), e.$inject = ["$scope", "$element", "$window", "$timeout", "$mdConstant", "$mdInkRipple", "$mdUtil"]
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
            ...
            return {
                ...
                link: function (t, n, r) {
                    angular.forEach(t.$$isolateBindings, function (e, n) {
                        e.optional && angular.isUndefined(t[n]) && (t[n] = r.hasOwnProperty(r.$normalize(e.attrName)))
                    }), r.$observe("mdNoBar", function (e) {
